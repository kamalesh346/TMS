...
//                 {selectedBooking.requiredStartTime
//                   ? new Date(selectedBooking.requiredStartTime).toLocaleString()
//                   : "Not specified"}
//               </Typography>
//               <Typography sx={{ mt: 1 }}>
//                 <strong>Req. End Time:</strong>{" "}
//                 {selectedBooking.requiredEndTime
//                   ? new Date(selectedBooking.requiredEndTime).toLocaleString()
//                   : "Not specified"}
//               </Typography>
